#ifndef MATGEN_BACKENDS_SEQ_INTERNAL_BILINEAR_SEQ_H
#define MATGEN_BACKENDS_SEQ_INTERNAL_BILINEAR_SEQ_H

/**
 * @file bilinear_seq.h
 * @brief Internal header for sequential bilinear interpolation
 *
...
/**
 * @brief Scale sparse matrix using bilinear interpolation (sequential)
 *
...
#endif  // MATGEN_BACKENDS_SEQ_INTERNAL_BILINEAR_SEQ_H
